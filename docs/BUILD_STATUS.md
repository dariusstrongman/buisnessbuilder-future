...
| `dariusstrongman/buisnessbuilder-future` | `main` / `b5a44761ce83f0032684f825829123380573536f` | `integration/offline-billy-bob-v1` / `988058981d8dde953d6c2b3b8f993015543b4a0e` | Unified Business Builder platform | Reviewed integration base for W5/W6/W8; main is intentionally unchanged. |
...
| Offline Integration | W4 + coordinator review | `integration/offline-billy-bob-v1` | `988058981d8dde953d6c2b3b8f993015543b4a0e` | **Durable and accepted as next-wave base; main unchanged** | Company Brain + Runtime + Verification | Hosted CI and final PR review still required before main | Fresh remote clone 99/99; package-ready, dependency retry, tenant evidence, approval binding, scenario completeness, and fresh-retest regressions pass | Safe base for isolated offline work; not yet main-ready | Add hosted CI and complete contract/adapter review before PR to main |
...
4. Add hosted CI; the accepted branch already passes 99/99 from a clean remote checkout.
